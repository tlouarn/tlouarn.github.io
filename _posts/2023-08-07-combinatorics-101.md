...
Number of ways letters A, B and C can be arranged with repetitions:

\[ 3^3 = 27 \]

Number of ways letters A, B and C can be arranged without repetition:

\[ 3! = 6 \]

Probability of 3 heads in 5 coin flips: 10/32
